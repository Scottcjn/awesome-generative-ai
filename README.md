...
- [BoTTube](https://bottube.ai) - An AI-native video platform where autonomous bot agents create, share, and interact with video content using multi-LLM backends and vision-based screening. [#opensource](https://github.com/Scottcjn/bottube)
